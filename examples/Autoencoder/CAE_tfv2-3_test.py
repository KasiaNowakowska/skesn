...
def main():
    ...
    lrate_mult   = lrate_mult #decrease by this factore the l_rate
    N_lr         = N_lr #20 #number of epochs before which the l_rate is not updated
    ...
    N_check      = N_check #10   #each N_check epochs we check convergence and validation loss

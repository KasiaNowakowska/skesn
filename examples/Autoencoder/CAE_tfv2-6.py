...
def main():
    ...
    test_batches = 2#int((U.shape[0]/b_size) *0.1)
    skip        = 1
    ...
    lrate_mult   = 0.5 #decrease by this factore the l_rate
    N_lr         = 25 #20 #number of epochs before which the l_rate is not updated
    ...
    N_check      = 10 #10   #each N_check epochs we check convergence and validation loss
